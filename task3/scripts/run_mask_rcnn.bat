...
REM Recommended: set this to a COCO pretrained Mask R-CNN checkpoint.
REM Example: set PRETRAIN=E:\checkpoints\mask_rcnn_r50_fpn_1x_coco.pth
set PRETRAIN=
...
python tools\eval_t3_metrics.py ^
  ...
  --out-dir "%OUT_ROOT%\t3_metrics\mask_rcnn_class_agnostic" ^
  --score-thr 0.001
